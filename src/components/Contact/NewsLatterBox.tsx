  ...
  return (
    <div className="relative z-10 rounded-lg bg-white p-8 shadow-three dark:bg-gray-dark sm:p-11 lg:p-8 xl:p-11">
      <h3 className="mb-4 text-3xl font-bold leading-tight text-black dark:text-white">
        Stay Ahead in AR Innovation – Subscribe for Updates
      </h3>
      <p className="mb-11 border-b border-body-color border-opacity-25 pb-11 text-base leading-relaxed text-body-color dark:border-white dark:border-opacity-25">
        Join the future of Augmented Reality and get the latest news on immersive experiences, groundbreaking AR tech, and upcoming product releases. 
      </p>
      <div>
        <input
          type="text"
        ...
        <p className="text-center text-base leading-relaxed text-body-color dark:text-body-color-dark">
          No spam. Only cutting-edge AR news straight to your inbox.
        </p>
      </div>
